...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-button text-primary-foreground shadow-glow hover:shadow-lg hover:scale-105",
        ...
        secondary: "bg-secondary/20 text-foreground hover:bg-secondary/30 backdrop-blur-glass",
        ghost: "hover:bg-accent/10 hover:text-accent",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-gradient-button text-primary-foreground shadow-glow hover:shadow-lg hover:scale-105 font-semibold",
        glass: "bg-white/10 backdrop-blur-glass border border-white/20 text-foreground hover:bg-white/20",
      },
      size: {
